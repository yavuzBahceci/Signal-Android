...
import com.app.signal.control_kit.SignalToolbar
import com.app.signal.control_kit.ex.pop

abstract class ActionBarToolbarFragment(@LayoutRes contentLayoutId: Int) : AnyFragment(contentLayoutId) {
    lateinit var toolbar: SignalToolbar
        private set
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        activity.setSupportActionBar(toolbar.primaryToolbar)
        ...
        if (fm.backStackEntryCount > 0) {
            ...
            toolbar.primaryToolbar.setNavigationOnClickListener {
                fm.pop()
            }
        }
    ...
    override fun onPause() {
        ...
        toolbar.primaryToolbar.dismissPopupMenus()
    }
}